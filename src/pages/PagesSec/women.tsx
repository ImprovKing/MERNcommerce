                ...
                <section className="pt-10 pb-10 " >
                    ...
                    <div className='' id="prod-container">
                        <div id='titlebox' className='li:p-1'>
                            <h2 className='p-4 text-left text-5xl font-bold sm:text-3xl sm:text-center sm:font-medium'>Women </h2>
                            <p className='text-sm text-lighter pl-2 sm:text-xs capitalize'> It all new . Browse our versatile selection and choose from a range of styles and washes that are
                                ...
                                Browse our Women collection below and find your new favorite pairs.</p>
                        ...
                        <ul className='pl-2 grid grid-cols-3 3xl:grid-cols-4  gap-0 lg:grid-cols-4 Llg:grid-cols-4 gi:grid-cols-3 sxs:grid-cols-2 sxs:gap-0 li:grid-cols-1 li:p-2 li:grid-cols-0 li:w-4/5 li:mx-auto li:my-auto ' >
